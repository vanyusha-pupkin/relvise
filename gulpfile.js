...
const path = {
  ...
  src:{
    ...
    js:             'src/js/main.js',
    img:            ['src/img/**/*.{jpeg,JPEG,jpg,JPG,png,PNG,gif,GIF,svg,SVG,ico.ICO,xml.XML,webmanifest}', '!src/img/svg-sprite/*.svg', '!src/img/svg-to-sass/*.svg'],
    imgWebpJPG:     ['src/img/**/*.{jpeg,JPEG,jpg,JPG}', '!src/img/favicons/*.*', '!src/img/icons/*.*'],
    imgWebpPNG:     ['src/img/**/*.{png,PNG}', '!src/img/favicons/*.*', '!src/img/icons/*.*'],
    svgSprite:      ['src/img/svg-sprite/*.{svg,SVG}', '!src/img/svg-sprite/sprite.svg'],
    svgToSass:      'src/img/svg-to-sass/*.{svg,SVG}',
  ...
  watch:{
    ...
    scss:        'src/scss/**/*.scss',
    js:          'src/js/**/*.js',
    img:         ['src/img/**/*.{jpeg,JPEG,jpg,JPG,png,PNG,gif,GIF,svg,SVG}', '!src/img/svg-sprite/*.svg'],
    svgSprite:   ['src/img/svg-sprite/*.{svg,SVG}', '!src/img/svg-sprite/sprite.svg'],
    svgToSass:   'src/img/svg-to-sass/*.{svg,SVG}',
